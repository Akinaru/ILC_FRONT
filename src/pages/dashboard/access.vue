                            ...
                            <table class="table table-zebra">
                                ...
                                <tbody>
                                    <tr v-for="(acc, index) in filteredEtudiants" :key="index">
                                        ...
                                        <th>
                                            <RouterLink :to="{name: 'Profile', params: {acc_id: acc.acc_id}}" class="tooltip" data-tip="Afficher le profil">
                                                <button class="hover:opacity-60 hover:cursor-pointer p-2">
                                                    <svg  width="24px" height="24px" class="stroke-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
